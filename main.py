...
def save_result(n, density, min_weight, max_weight, graph_generation_time, adjacency_matrix_generation_time, algorithm_work_time):
    results = []
    try:
...
def main():
    ...
    for _ in range(2):
        ...
        print(f"Graph with n={n}, density={density}, min_weight={min_weight}, max_weight={max_weight} generated in {graph_generation_time} ms")
        algorithm = AlgorithmFloydWorshell(graph)
        print(f"Graph with n={n}, density={density}, min_weight={min_weight}, max_weight={max_weight} adjacency matrix:")
        ...
        print(f"Output of algorithm (graph with n={n}, density={density}, min_weight={min_weight}, max_weight={max_weight}):")
        ...
        # save_result(n=n, density=density, min_weight=min_weight, max_weight=max_weight, graph_generation_time=graph_generation_time, adjacency_matrix_generation_time=adjacency_matrix_generation_time, algorithm_work_time=algorithm_work_time)
